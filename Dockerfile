...
RUN apt-get install -y libcurl4-gnutls-dev python-django-celery python-mysqldb python-pip python-pycurl libxml2-dev python-dev python-Imaging nginx && rm -rf /var/cache/apt/archives/*.deb
